...
const sandwiches = {
	...
	3: {
		...
		name: 'X-Egg',
		ingredients: [3, 4, 5, 6],
		image: 'https://static.expressodelivery.com.br/imagens/produtos/4827/180/Expresso-Delivery_2a753836ab2b68ac7fac38a638de619a.png'
	},
	4: {
		id: 4,
		name: 'X-Egg Bacon',
		ingredients: [1, 2, 3, 4, 5, 6],
		image: 'https://www.zapvendas.com.br/upload/55/f0aa7dd441651f23cef66e3d1f9af1b1.png'
	}
}
...
const promos = {
	...
	2: {
		id: 2,
		name: 'Muita carne',
		description: 'A cada 3 porções de carne só paga 2. Se o lanche tiver 6 porções, pagará 4. Assim por diante'
	},
	3: {
		id: 3,
		name: 'Muito queijo',
		description: 'A cada 3 porções de queijo só paga 2. Se o lanche tiver 6 porções, pagará 4. Assim por diante'
	}
}
